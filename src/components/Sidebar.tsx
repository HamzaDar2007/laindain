...
const Sidebar: React.FC = () => {
    ...
    const navItems = [
        ...
        { path: '/integrations', icon: 'integrations', label: 'Integrations' },
        ...
        <aside className="w-64 bg-white border-r border-gray-200 flex flex-col">
            ...
            <div className="p-4 border-t border-gray-200">
                <button
                    ...
                    className="w-full flex items-center space-x-3 px-4 py-2 rounded-lg text-red-600 hover:bg-red-50 transition-colors duration-200 mb-4"
                >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
